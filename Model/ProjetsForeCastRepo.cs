...
{
    public class ProjetsForeCastRepo
    {
        private readonly IConfiguration? _configuration;
        public ProjetsForeCastRepo(IConfiguration? configuration)
        {
            _configuration = configuration;

        }

        public ProjetsForeCastEntitity GetProjet(int id)
        {

            var oSqlParam = new SqlParameter("@Id", id);
            var oConnaissances = new ProjetsForeCastEntitity();
        ...
        public List<ProjetsForeCastEntitity> GetAllProjets()
        {
            var oList = new List<ProjetsForeCastEntitity>();
            var oSqlConnection = new SqlConnection(_configuration?.GetConnectionString("SQL"));
            ...
            {
                oList.Add(new ProjetsForeCastEntitity
                {
        ...
        public bool UpdateProjet(ProjetsForeCastEntitity fc)
        {
            try
            {
        ...
        public int CreateProjet(ProjetsForeCastEntitity fc)
        {
            try
            {
