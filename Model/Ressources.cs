...
namespace XefiAcademyAPI.Model
{
    public class Ressources
    {
        ...
        public Ressources(IConfiguration? configuration)
        {
            _configuration = configuration;

        }

        public RessourcesEntitity GetRessource(int id)
        {

            var oSqlParam = new SqlParameter("@Id", id);
            var oRessources = new RessourcesEntitity();
        ...
        public List<RessourcesEntitity> GetAllRessources()
        {
            var oList = new List<RessourcesEntitity>();
            var oSqlConnection = new SqlConnection(_configuration?.GetConnectionString("SQL"));
            ...
            {
                oList.Add(new RessourcesEntitity
                {
        ...
        public bool UpdateRessource(RessourcesEntitity fc)
        {
            try
            {
        ...
        public int CreateRessource(RessourcesEntitity fc)
        {
            try
            {
        ...
        public int ReadNumberRessources()
        {
            try
            {

                var oSqlConnection = new SqlConnection(_configuration?.GetConnectionString("SQL"));
                var oSqlCommand = new SqlCommand("select count(*) from Ressources");
                oSqlCommand.Connection = oSqlConnection;
